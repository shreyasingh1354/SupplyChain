...
export default() =>{
  ...
  useEffect(() => {
    document.onclick = (event) => {
      if (!event.target.closest(".menu-btn") && !event.target.closest(".nav-container")) {
        setState(false);
      }
    };
  
    return () => {
      document.onclick = null; // Clean up event listener on unmount
    };
  }, []);
  ...
  return (
    ...
    >
      <div className="gap-x-14 items-center max-w-screen-xl mx-auto px-4 md:flex md:px-8">
        <div className="flex flex-row items-center justify-between py-5 md:block">
          <a>
            <img
        ...
        >
          ...
          <div className="flex-1 gap-x-6 items-center justify-end mt-6 space-y-6 md:flex md:space-y-0 md:mt-0">
            {currentUser ? (
              ...
              <button title="Connect your MetaMask wallet and view connection details"
